...
public class BookService {
    ...
    static {
        ...
        books.add(new Book("Eric Ries",
                "The Lean Startup: How Constant Innovation Creates Radically Successful Businesses", "lean.jpg"));
        books.add(new Book("Geoffrey A. Moore", "Crossing the Chasm", "chasm.jpg"));
        // books.add(new Book("David Thomas","The Pragmatic Programmer: From Journeyman
        // to Master", "pragmatic.jpg"));
        // books.add(new Book("Frederick P. Brooks Jr.", "The Mythical Man-Month: Essays
        // on Software Engineering", "month.jpg"));
